...
public class FaceUtil {
	...
	public static void setSessionUser(User user) {
		if (user != null) {
			...
			setSessionMapValue(USER_ATTRIBUTE, null);
	...
	public static void refreshUser(UserDAO userDao) {
		User u = FaceUtil.getSessionUser();
		if (u != null) {
			String email = u.getEmail();
			String pass = u.getPassword();

			User nu = userDao.Connect(email, pass);

			FaceUtil.setSessionUser(nu);
		}
